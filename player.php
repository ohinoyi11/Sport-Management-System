...
<body>
    ...
    <header>
        ...
        <p>Add, edit, view, and delete player information</p>
    </header>

    <!-- Navbar -->
    <nav>
        <a href="input_player.html"><i class="fas fa-user-plus"></i> Add Player</a>
        <a href="update_player.php"><i class="fas fa-user-edit"></i> Update Player</a>
        <a href="delete_player.php"><i class="fas fa-user-minus"></i> Delete Player</a>
        <a href="export_players.php"><i class="fas fa-file-export"></i> Export Data</a>
    </nav>
    ...
    <div class="container">
        ...
        <div class="controls">
            ...
            <div class="action-buttons">
                ...
                <button class="btn btn-secondary" onclick="window.location.href='input_player.html'">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr data-player-id='" . $row["player_id"] . "'>
                                ...
                                <td class='action-cell'>
                                    ...
                                    <button class='action-btn edit-btn' onclick='editPlayer(" . $row["player_id"] . ")'>
                                        <i class='fas fa-edit'></i>
                                    </button>
                                    <button class='action-btn delete-btn' onclick='deletePlayer(" . $row["player_id"] . ")'>
    ...
    initPagination();
        ...
        function viewPlayer(playerId) {
            ...
            const details = [
                ...
                { label: 'Faculty', value: playerData.dataset.employment },
                { label: 'Department', value: playerData.dataset.education },
                { label: 'Level', value: playerData.dataset.company },
