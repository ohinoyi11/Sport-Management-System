...
<body>
    ...
    <!-- Navbar -->
    <nav>
        <a href="input_team.html"><i class="fas fa-plus-circle"></i> Add Team</a>
        <a href="update_team.php"><i class="fas fa-edit"></i> Update Team</a>
        <a href="match.php"><i class="fas fa-futbol"></i> Matches</a>
        <a href="player.php"><i class="fas fa-users"></i> Players</a>
    </nav>
    ...
    <div class="container">
        ...
        <div class="controls">
            ...
            <div class="action-buttons">
                ...
                <button class="btn btn-secondary" onclick="window.location.href='input_team.html'">
            ...
            ?>
                <div class="team-card" data-team-id="<?php echo $row["team_id"]; ?>" data-team-name="<?php echo $row["team_name"]; ?>" data-location="<?php echo $row["location"]; ?>">
                    ...
                    <div class="team-card-actions">
                        ...
                        <button class="card-btn edit-btn" onclick="editTeam(<?php echo $row["team_id"]; ?>)">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button class="card-btn delete-btn" onclick="deleteTeam(<?php echo $row["team_id"]; ?>)">
    ...
    <footer class="footer">
        <div class="footer-links">
            <a href="input_team.html"><i class="fas fa-plus-circle"></i> Add New Team</a>
            <a href="update_team.php"><i class="fas fa-edit"></i> Update Team</a>
            <a href="match.php"><i class="fas fa-futbol"></i> View Matches</a>
            <a href="player.php"><i class="fas fa-users"></i> View Players</a>
            <a href="adminhome.php"><i class="fas fa-home"></i> Back to Dashboard</a>
        </div>
