...
<body>
    ...
    <nav>
        ...
        <a href="update_contract.php"><i class="fas fa-edit"></i> Update Contract</a>
    ...
    <div class="container">
        ...
        <div class="controls">
            ...
            <div class="action-buttons">
                <button class="btn btn-secondary" onclick="window.location.href='input_contract.html'">
                    ...
                    while($row = $result->fetch_assoc()){
                        echo "<tr>
                            ...
                            <td class='action-cell'>
                                ...
                                <button class='action-btn edit-btn' onclick='editContract(" . $row["contract_id"] . ")'>
                                    <i class='fas fa-edit'></i>
                                </button>
                                <button class='action-btn delete-btn' onclick='deleteContract(" . $row["contract_id"] . ")'>
    ...
    <footer>
        <div class="footer-links">
            ...
            <a href="update_contract.php">Update Contract</a>
